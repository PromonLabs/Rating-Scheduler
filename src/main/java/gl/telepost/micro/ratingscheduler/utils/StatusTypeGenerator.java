...
public class StatusTypeGenerator
{
    ...
    public static final StatusType generateStatusType(String errorMessage, int statusCode) {
        StatusType status = new StatusType();
...
//    public static final StatusType generateStatusType(ESBServiceException exception) {
//        StatusType status = new StatusType();
