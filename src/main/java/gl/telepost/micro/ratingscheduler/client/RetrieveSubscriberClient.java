...
public class RetrieveSubscriberClient {
	...
	private GetServiceInformationV3RequestType getServiceInformationV3Request(
			ServiceType serviceType) {
		GetServiceInformationV3RequestType getServiceInformationV3RequestType = new GetServiceInformationV3RequestType();
		...
		getServiceInformationV3RequestTypeRepo
				.save(getServiceInformationV3RequestType);
	...
	private GetServiceInformationV3ResponseType getServiceInformation(
		...
		GetServiceInformationV3RequestType getServiceInformationV3RequestType = getServiceInformationV3Request(serviceType);
